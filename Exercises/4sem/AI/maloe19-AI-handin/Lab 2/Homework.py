...
def successor_fn(state):  # Lookup list of successor states
    return [
        ...
        if not (goat != farmer and goat == wolf)
        if not (goat != farmer and goat == cabbage)
    ]

INITIAL_STATE = ('W', 'W', 'W', 'W')
GOAL_STATE = ('E', 'E', 'E', 'E')
STATE_SPACE = {
    ('W', 'W', 'W', 'W'): [('E', 'E', 'W', 'W'), ('E', 'W', 'W', 'W'), ('E', 'W', 'W', 'E'), ('E', 'W', 'E', 'W')],
    ('E', 'E', 'W', 'W'): [('W', 'W', 'W', 'W'), ('W', 'E', 'W', 'W')],
    ('E', 'W', 'E', 'W'): [('W', 'W', 'W', 'W'), ('W', 'W', 'E', 'W')],
    ('E', 'W', 'W', 'E'): [('W', 'W', 'W', 'W'), ('W', 'W', 'W', 'E')], 
    ('W', 'E', 'W', 'W'): [('E', 'E', 'E', 'W'), ('E', 'E', 'W', 'W'), ('E', 'E', 'W', 'E')], 
    ('W', 'W', 'E', 'W'): [('E', 'E', 'E', 'W'), ('E', 'W', 'E', 'W'), ('E', 'W', 'E', 'E')],  
    ('W', 'W', 'W', 'E'): [('E', 'E', 'W', 'E'), ('E', 'W', 'W', 'E'), ('E', 'W', 'E', 'E')], 
    ('E', 'E', 'E', 'W'): [('W', 'W', 'E', 'W'), ('W', 'E', 'E', 'W'), ('W', 'E', 'W', 'W')], 
    ('E', 'W', 'E', 'E'): [('W', 'W', 'E', 'W'), ('W', 'W', 'W', 'E'), ('W', 'W', 'E', 'E')], 
